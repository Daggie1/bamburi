...
//    private View mCenterLayout;
    ...
    private SeekBar.OnSeekBarChangeListener mSeekListener = new SeekBar.OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar bar, int progress, boolean fromuser) {
            ...
            if (mCurrentTime != null) mCurrentTime.setText(stringToTime((int) newPosition));
        }
    ...
    private View makeControllerView() {
        ...
        mRootView = inflate.inflate(R.layout.mediacontroller, null);
        initControllerView();
...
//        mCenterProgress = mRootView.findViewById(R.id.progress_center);
    ...
    private void show() {
        ...
        if (!mIsShowing && mAnchorView != null) {
            ...
            LayoutParams tlp = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
            mAnchorView.addView(VideoControllerView.this, tlp);

            ViewAnimator.putOn(mBottomLayout).waitForSize(new ViewAnimator.Listeners.Size() {
                @Override
...
//                                    .andAnimate(mBottomLayout)
                            .translationY(-mBottomLayout.getHeight(), 0).duration(ANIMATE_TIME).start(new ViewAnimator.Listeners.Start() {
                        @Override
                        public void onStart() {
                            mIsShowing = true;
                            mHandler.sendEmptyMessage(HANDLER_UPDATE_PROGRESS);
    ...
    private void hide() {
        ...
        ViewAnimator.putOn(mBottomLayout).animate()
//                .translationY(-mTopLayout.getHeight())
//                .duration(ANIMATE_TIME)
//                .andAnimate(mBottomLayout)
                .translationY(-mBottomLayout.getHeight()).duration(ANIMATE_TIME).end(new ViewAnimator.Listeners.End() {
            @Override
            public void onEnd() {
    ...
    private int setSeekProgress() {
        ...
        if (mEndTime != null) mEndTime.setText(stringToTime(duration));
...
//        mCenterLayout.setVisibility(VISIBLE);
    ...
    public static class Builder {
        ...
        @DrawableRes
        private int exitIcon = R.drawable.ic_close_black_24dp;
        @DrawableRes
